...
My annual salary target is around GBP 120,000, ideally GBP 120,000 or more. A stated salary below that should reduce the practical-compatibility score, but is not an automatic rejection or a hard minimum: the overall opportunity would need weighing up. Missing pay information is unknown, not evidence of low pay. I have not specified a base-versus-total-compensation split, an equity trade-off or a contractor day rate; do not invent those.
