...
function reviewCopy(kind, job, { researchAction = "none", count = 0 } = {}) {
  ...
  if (kind === "jev-score") return { ...common, title: "Assess fit with Jev", submitLabel: "Assess fit",
    steps: ["Estimate all five fit dimensions against your profile and saved preferences, including sparse role details", "Flag missing evidence separately from scores and check explicit hard constraints"],
