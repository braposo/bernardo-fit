...
const DIMENSION_GUIDANCE = {
  ...
  practical: {
    assess: "Compare stated arrangements with the profile's remote-first preference from Harrogate, UK, and UK work eligibility without sponsorship. London around one day weekly with occasional two-to-three-day visits, or Leeds/Manchester two-to-three days weekly, can be workable; remote remains preferred. Compare stated annual salary with the GBP 120,000 target: lower stated pay should reduce practical fit, not automatically reject a job. A range spanning the target is uncertain, not definitely below it. Do not assume a base-versus-total-compensation split or convert foreign currency without supplied conversion information. These are preferences, not hard constraints. Separate preferences from explicitly non-negotiable constraints; do not invent a salary floor. Unknown salary, travel or eligibility details are uncertainty, not a conflict. When all practical details are absent, use the midpoint as an explicitly uncertain estimate.",
...
const SCORING_POLICY = "2026-09-20-preferences-2";
