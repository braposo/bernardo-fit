...
const DIMENSION_GUIDANCE = {
  responsibilities: {
    assess: "Compare the main day-to-day activities with the candidate's preferred mix of engineering leadership, technical direction, product and design collaboration. Focus on the work itself; assess proven capability, seniority and future ambitions in their separate dimensions.",
  ...
  direction: {
    assess: "Compare the role with explicitly stated ambitions: engineering leadership with product and technical depth, AI, developer experience, Web3, early-stage CTO or technical co-founder work, and autonomy. A strong match to one desired path can merit a high score; the role need not combine every interest. Judge central responsibilities, not company keywords. Do not invent a preferred industry or require a more prestigious title.",
  ...
  practical: {
    assess: "Compare stated arrangements with remote-first work from Harrogate, UK, occasional travel and UK work eligibility without sponsorship. Separate preferences from explicitly non-negotiable constraints. Assess compensation only against a stated salary preference; do not invent a salary floor. Unknown salary, travel or eligibility details are uncertainty, not a conflict. When all practical details are absent, use the midpoint as an explicitly uncertain estimate.",
...
const SCORING_POLICY = "2026-09-20-estimates-1";
