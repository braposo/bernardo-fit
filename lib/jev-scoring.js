...
// their original inputs still match and all migrated editorial content is intact.
...
export function assessmentIsCurrent(job) {
  ...
  return !!fingerprint && (fingerprint===scoringFingerprint(job) ||
    analysisSettings().legacyScoringCompatible===true && fingerprint===legacyScoringFingerprint(job));
}
