...
Fifteen-plus years across frontend architecture, design systems, UX, AI products, and full-stack work. I'm available now. I spent five years as Engineering Manager at SingleStore and left at the end of May 2026 when the company restructured after a private-equity buyout. That was the second time in my career a company I was at went through acquisition-driven restructuring (Emirates Group during COVID was the first), and both times I read it early and made a proactive move rather than waiting it out. I'm open to an engineering leadership role, a CTO/technical co-founder seat at an early-stage startup, or going all-in on The Hermans or a new venture, depending on what shows up. UK Settled Status, no sponsorship needed (my kids hold UK passports too). Remote-first, based in Harrogate, open to occasional travel. Portuguese, from Coimbra, in the UK 12 years. Portuguese native, English fluent.
...
**Open source (1,500+ GitHub stars).** Under github.com/braposo: **react-text-loop** (878★, ~3,500 weekly npm downloads), an animated text loop for React headings, popular enough that someone forked it specifically to keep it alive after I stopped maintaining it; **figma-graphql** (395★), a GraphQL wrapper around the Figma API, "making design more human," with a v2 I was building toward TypeScript + file normalisation + caching; **react-responsive-picture** (100★, ~1,200 weekly downloads), which implements the HTML Picture spec; plus figma-transformer and singlestore-notes (an early React Server Components experiment on SingleStore). Under github.com/aeminium-labs, my Web3 org, named after Aeminium, the Roman name for Coimbra, "building the foundations of a more accessible Web3": **nextjs-solana-starter-kit** (102★, widely forked), a full Solana dApp template with wallet auth, SOL/SPL transactions, Helius API, theming, and server-side transaction handling for security; **GraphQLana**, "Solana's blockchain data for humans," the same wrapping philosophy as figma-graphql applied to Solana; **solana-nft-monitor** (26★), which uses GitHub Actions as free CI/CD to monitor NFT project data; and **Simpl3**, a three-part Web3 auth platform I eventually discontinued when it didn't find product-market fit. The pattern across all of it: complex systems made human-friendly through an abstraction layer, whether that's Figma, Solana, or design tools talking to each other.
...
I'm a lifelong competitor across three decades of different games: competitive Counter-Strike as a teenager; nearly 20 years of tennis, top-50 in Portugal, stopped competing before moving to the UK; padel now, where I'm currently top 40 in the UK for over-40s and was top 25 in the UK overall a few years back, playing several times a week (padel is also what inspired one of my Solana side-projects, padelcash); and more recently taekwondo and climbing (bouldering and sport).
